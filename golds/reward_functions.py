...
def _value_of_holdings(holdings: Holdings, prices: Valuation) -> float:
...
class NaiveHedgingRewardFunction(RewardFunction):
    ...
    def evaluate_reward(self, trade: Trade, market_data_state: MarketDataState) -> Tuple[float, bool]:
        ...
        trade_value: float = _value_of_holdings(trade, self._prev_prices)
        ...
        reward = delta_wealth - (self.kappa/2)*(delta_wealth ** 2)
