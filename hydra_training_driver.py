...
OVERLAY_FILEPATH = os.path.join(os.environ["SCRATCH"], "rl_finance_singularity/rl_finance.ext3")
...
TRAIN_SINGULARITY_FILEPATH = os.path.join(os.environ["SCRATCH"], "RL-Finance", "train_singularity.py")
...
def main(cfg: DictConfig):
    ...
    subprocess.run(
        [
            ...
            "/bin/bash", "-c", f"source /ext3/env.sh; python {TRAIN_SINGULARITY_FILEPATH} {hydra_config_filepath}"
        ]
    )
