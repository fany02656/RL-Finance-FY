...
def print_usage():
    print("Usage: python3 train_singularity.py <path_to_config_yaml>")
...
def main():
    ...
    policy_kwargs = {"activation_fn": nn.ReLU, "net_arch": cfg["net_arch"]}
    ...
    model.learn(total_timesteps=cfg['total_training_timesteps'], callback=[logger_callback])
